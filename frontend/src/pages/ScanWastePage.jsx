...
function ScanWastePage() {
    ...
    const handleAwardPoints = async (points) => {
        ...
        try {
            ...
            const response = await fetch('http://192.168.29.228:5000/api/users/me/score', { // Verify URL/Port
                method: 'POST',
    ...
    const handleAnalyzeClick = async () => {
        ...
        try {
            const backendUrl = 'http://192.168.29.228:5000/api/analyze'; // Verify URL/Port
